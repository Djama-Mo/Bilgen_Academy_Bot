...
def informatika(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}informatika 11')
...
def matematika(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}mat 11')
    button_back = InlineKeyboardButton(text='🔙 Назад', callback_data=f'Список {sprint_ru} 11')
...
def kaz_yaz(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}kaz 11')
    button_back = InlineKeyboardButton(text='🔙 Назад', callback_data=f'Список {sprint_ru} 11')
...
def kaz_lit(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}kazl 11')
    button_back = InlineKeyboardButton(text='🔙 Назад', callback_data=f'Список {sprint_ru} 11')
...
def bio(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}bio 11')
    button_back = InlineKeyboardButton(text='🔙 Назад', callback_data=f'Список {sprint_ru} 11')
...
def xim(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}xim 11')
    button_back = InlineKeyboardButton(text='🔙 Назад', callback_data=f'Список {sprint_ru} 11')
...
def fiz(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}fiz 11')
    button_back = InlineKeyboardButton(text='🔙 Назад', callback_data=f'Список {sprint_ru} 11')
...
def hkz(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}hkz 11')
    button_back = InlineKeyboardButton(text='🔙 Назад', callback_data=f'Список {sprint_ru} 11')
...
def hm(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}hm 11')
    button_back = InlineKeyboardButton(text='🔙 Назад', callback_data=f'Список {sprint_ru} 11')
...
def geo(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}geo 11')
    button_back = InlineKeyboardButton(text='🔙 Назад', callback_data=f'Список {sprint_ru} 11')
...
def ang(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}ang 11')
    button_back = InlineKeyboardButton(text='🔙 Назад', callback_data=f'Список {sprint_ru} 11')
...
def mat_bil(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{mat}11')
...
def gum_bil(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{gum}11')
    button_back = InlineKeyboardButton(text='🔙 Назад', callback_data=f'Нап {bala_time_ru} 11')
