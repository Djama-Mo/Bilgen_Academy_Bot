...
def sprint_subject_7_ru(callback, bot, subj):
    markup = InlineKeyboardMarkup()

    button = InlineKeyboardButton(text=start_the_test_ru, callback_data=f'spr_{subj}_7_ru')
    button_back = InlineKeyboardButton(text='К списку олимпиад', callback_data=f'Олимпиады 7')
...
def sprint_subject_7_kz(callback, bot, subj):
    markup = InlineKeyboardMarkup()

    button = InlineKeyboardButton(text=start_the_test_kz, callback_data=f'spr_{subj}_7_kz')
    button_back = InlineKeyboardButton(text='Олимпиадалар тізімі', callback_data=f'Олимпиады 7kz')
