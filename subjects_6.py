...
def reply_sprint_list_ru(callback, bot):
    ...
    markup_url.add(button_2, button_3).add(button_4).add(button_7).add(button_6).add(button_9).add(button_10).add(button_back)
...
def reply_sprint_list_kz(callback, bot):
    ...
    markup_url.add(button_2, button_3).add(button_4).add(button_7).add(button_6, button_9).add(button_10).add(button_back)
    bot.send_message(chat_id=callback.message.chat.id, text='\n\nПәндер тізімі\n\n', reply_markup=markup_url)
