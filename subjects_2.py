...
def reply_sprint_list_ru(callback, bot):
    ...
    button_1 = InlineKeyboardButton(text='Математика', callback_data=f'Мат {sprint_ru} 2')
...
def reply_bilik_time_ru(callback, bot):
    ...
    button_1 = InlineKeyboardButton(text='Информация', callback_data=f'Нап {bala_time_ru} 2')
...
def reply_sprint_list_kz(callback, bot):
    ...
    button_1 = InlineKeyboardButton(text='Математика', callback_data=f'Мат {sprint_kz} 2')
...
def mat(callback, bot):
    ...
    bot.delete_message(chat_id=callback.message.chat.id, message_id=callback.message.message_id)
    bot.send_message(chat_id=callback.message.chat.id, text=text("Математика", 2, 30, 60, 350),
...
def kaz(callback, bot):
    ...
    markup_url.add(button).add(button_back)
    bot.delete_message(chat_id=callback.message.chat.id, message_id=callback.message.message_id)
    bot.send_message(chat_id=callback.message.chat.id, text=text("Казахский язык", 2, 30, 60, 350),
                     reply_markup=markup_url, parse_mode='html')
...
def kazl(callback, bot):
    ...
    markup_url.add(button).add(button_back)
    bot.delete_message(chat_id=callback.message.chat.id, message_id=callback.message.message_id)
    bot.send_message(chat_id=callback.message.chat.id, text=text("Казахская литература", 2, 30, 60, 350),
                     reply_markup=markup_url, parse_mode='html')
...
def reply_doda_dir_ru(callback, bot):
    ...
    button_1 = InlineKeyboardButton(text=f'{doda_dir_lan_ru}', callback_data=f'{doda_dir_lan_ru}2')
...
def mat_kz(callback, bot):
    ...
    markup_url.add(button).add(button_back)
    bot.delete_message(chat_id=callback.message.chat.id, message_id=callback.message.message_id)
    bot.send_message(chat_id=callback.message.chat.id, text=text_kz("Математика", 2, 30, 60, 350),
                     reply_markup=markup_url, parse_mode='html')
...
def kaz_kz(callback, bot):
    ...
    markup_url.add(button).add(button_back)
    bot.delete_message(chat_id=callback.message.chat.id, message_id=callback.message.message_id)
    bot.send_message(chat_id=callback.message.chat.id, text=text_kz("Қазақ тілі", 2, 30, 60, 350),
                     reply_markup=markup_url, parse_mode='html')
...
def kazl_kz(callback, bot):
    ...
    markup_url.add(button).add(button_back)
    bot.delete_message(chat_id=callback.message.chat.id, message_id=callback.message.message_id)
    bot.send_message(chat_id=callback.message.chat.id, text=text_kz("Қазақ әдебиеті", 2, 30, 60, 350),
                     reply_markup=markup_url, parse_mode='html')
...
def reply_doda_dir_kz(callback, bot):
    ...
    button_1 = InlineKeyboardButton(text=f'{doda_dir_lan_kz}', callback_data=f'{doda_dir_lan_kz}2')
