...
def sprint_subject_1_ru(callback, bot, subj):
    markup = InlineKeyboardMarkup()

    button = InlineKeyboardButton(text=start_the_test_ru, callback_data=f'spr_{subj}_1_ru')
    button_back = InlineKeyboardButton(text='К списку олимпиад', callback_data=f'Олимпиады 1')
...
def sprint_subject_1_kz(callback, bot, subj):
    markup = InlineKeyboardMarkup()

    button = InlineKeyboardButton(text=start_the_test_kz, callback_data=f'spr_{subj}_1_kz')
    button_back = InlineKeyboardButton(text='Олимпиадалар тізімі', callback_data=f'Олимпиады 1kz')
