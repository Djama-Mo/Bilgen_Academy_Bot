...
def reply_sprint_list_ru(callback, bot):
    ...
    markup_url.add(button_3, button_7).add(button_8).add(button_9, button_2).add(button_4).add(button_10, button_5).\
        add(button_11).add(button_1, button_6).add(button_back)
...
def reply_sprint_list_kz(callback, bot):
    ...
    markup_url.add(button_3, button_7).add(button_8).add(button_9, button_2).add(button_4).add(button_9).\
        add(button_10, button_5).add(button_11).add(button_1, button_6).add(button_back)
    bot.send_message(chat_id=callback.message.chat.id, text='\n\nПәндер тізімі\n\n', reply_markup=markup_url)
...
def informatika(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}informatika 8')
...
def matematika(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}mat 8')
    button_back = InlineKeyboardButton(text='🔙 Назад', callback_data=f'Список {sprint_ru} 8')
...
def kaz_yaz(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}kaz 8')
    button_back = InlineKeyboardButton(text='🔙 Назад', callback_data=f'Список {sprint_ru} 8')
...
def kaz_lit(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}kazl 8')
    button_back = InlineKeyboardButton(text='🔙 Назад', callback_data=f'Список {sprint_ru} 8')
...
def bio(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}bio 8')
    button_back = InlineKeyboardButton(text='🔙 Назад', callback_data=f'Список {sprint_ru} 8')
...
def xim(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}xim 8')
    button_back = InlineKeyboardButton(text='🔙 Назад', callback_data=f'Список {sprint_ru} 8')
...
def fiz(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}fiz 8')
    button_back = InlineKeyboardButton(text='🔙 Назад', callback_data=f'Список {sprint_ru} 8')
...
def hkz(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}hkz 8')
    button_back = InlineKeyboardButton(text='🔙 Назад', callback_data=f'Список {sprint_ru} 8')
...
def hm(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}hm 8')
    button_back = InlineKeyboardButton(text='🔙 Назад', callback_data=f'Список {sprint_ru} 8')
...
def geo(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}geo 8')
    button_back = InlineKeyboardButton(text='🔙 Назад', callback_data=f'Список {sprint_ru} 8')
...
def ang(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}ang 8')
    button_back = InlineKeyboardButton(text='🔙 Назад', callback_data=f'Список {sprint_ru} 8')
...
def mat_bil(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{mat}8')
...
def gum_bil(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{gum}8')
    button_back = InlineKeyboardButton(text='🔙 Назад', callback_data=f'Нап {bala_time_ru} 8')
