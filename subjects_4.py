...
def mat(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}mat 4')
...
def kaz(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}kaz 4')
    button_back = InlineKeyboardButton(text='🔙 Назад', callback_data=f'Список {sprint_ru} 4')
...
def kazl(callback, bot):
    ...
    button = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{sprint_ru}kazl 4')
    button_back = InlineKeyboardButton(text='🔙 Назад', callback_data=f'Список {sprint_ru} 4')
...
def reply_bilik_time_list_ru(callback, bot):
    ...
    button_1 = InlineKeyboardButton(text='🧑🏻‍🎓 Участвовать', callback_data=f'{bala_time_ru}4')
    bot.delete_message(chat_id=callback.message.chat.id, message_id=callback.message.message_id)
...
def lan_ru(callback, bot):
    ...
    button_1 = InlineKeyboardButton(text=f'🧑🏻‍🎓 Участвовать', callback_data=f'ling_4_ru')
    bot.delete_message(chat_id=callback.message.chat.id, message_id=callback.message.message_id)
...
def log_ru(callback, bot):
    ...
    button_1 = InlineKeyboardButton(text=f'🧑🏻‍🎓 Участвовать', callback_data=f'log_4_ru')
    bot.delete_message(chat_id=callback.message.chat.id, message_id=callback.message.message_id)
